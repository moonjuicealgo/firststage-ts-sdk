...
import { FirstStageDeflexQuote } from "../src/client.js";

// --- Asset Info ---
const ASSET_IN_ID = 2154668640;
const ASSET_OUT_ID = 3159727942;
const AMOUNT = 100000_00000000n;
...
async function main() {
  try {
    ...
    // Generate the full swap group
    const composer = await sdk.generateDeflexSwapGroup(
      quote.txnPayload,
      USER_ADDRESS,
      REFERRAL_ADDRESS,
      ASSET_IN_ID,
  ...
  console.error('Error generating Deflex full swap group:');
  console.dir(err, { depth: null });          // full object
