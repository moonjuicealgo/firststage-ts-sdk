...
import { UserTxnWithSigner } from "./index.js";
...
export declare class FirstStageSDK {
    ...
    fetchDeflexQuoteWithTax({ fromAssetId, toAssetId, amount, type, disabledProtocols, feeBps, deflexReferrerAddress, network, deflexApiUrl, deflexApiKey, algodToken, algodServer, algodPort, slippage, maxGroupSize, }: {
        fromAssetId: number;
        toAssetId: number;
        amount: number;
    ...
    generateDeflexSwapGroup(quote: FirstStageDeflexQuote, userAddress: string, referralAddress: string, fromAssetId: number, toAssetId: number, slippage?: number, defaultSigner?: algosdk.TransactionSigner, apiKey?: string): Promise<TransactionComposer>;
    ...
    generatePeraSwapGroup(userAddress: string, fromAssetId: number, toAssetId: number, amount: number, referralAddress: string, slippage?: number, providers?: ("tinyman" | "vestige-v4")[], defaultSigner?: algosdk.TransactionSigner): Promise<TransactionComposer>;
