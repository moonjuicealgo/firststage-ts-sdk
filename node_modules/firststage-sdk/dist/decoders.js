export function decodeAssetBox(bytes) {
    ...
    // Adjust flag offset to match your struct layout.
    // If your struct ends at byte 200 for UInt64s, flags may be at 248 (as in your original).
    const flags = bytes[248] ?? 0;
    ...
    const total_tax_bps = readUint64BE(64) + // project
        ...
        readUint64BE(96); // liquidity_tax_bps
    return {
